<?php 
    ...
    if(isset($_POST['update_bestelling'])) {
        ...
        header('Location: ../admin/adminbestellingen.php?Bestelling-status-updated');    
    }
    ...
    if(isset($_GET['verwijder'])) {
        ...
        header('Location: ../admin/adminbestellingen.php');
    }
?>
    ...
    <div class="box-container">
        ...
        <div class="bestelling-box">
            ...
            <form action="" method="POST">
                ...
                <a href="../admin/adminbestellingen.php?verwijder=<?php echo $fetch_bestelling['idbestelling']; ?>" class="verwijder_bestelling_knop" onclick="return confirm('verwijder dit bestelling?);">Verwijder</a>
            </form>
        </div>
